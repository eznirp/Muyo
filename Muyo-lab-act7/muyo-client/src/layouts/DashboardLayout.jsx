...
import { clearCurrentUser, getCurrentUser } from '../data/users';

const navigation = [
  { label: 'Dashboard', to: '/dashboard', icon: 'D' },
  { label: 'Articles', to: '/dashboard/articles', icon: 'A' },
  { label: 'Reports', to: '/reports', icon: 'R', adminOnly: true },
  { label: 'Users', to: '/users', icon: 'U', adminOnly: true },
];
...
const DashboardLayout = () => {
  ...
  const visibleNavigation = navigation.filter((item) => !item.adminOnly || currentUser.role === 'Admin');
